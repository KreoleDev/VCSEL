...
if($common['security']->check_rights(0)){
    require_once('common/includes/header_inner.inc.php');
        ...
        echo $common['window']->begin('TLAs');
            ...
            $results = $common['db']->pec('SELECT ext_tla_id, rev_timestamp FROM 2019_prod_tla_info_product_5 ORDER BY rev_timestamp ASC',
            ...
            $results = $common['db']->pec('SELECT tla_id, tla_number, active FROM 2019_prod_tlas WHERE ext_product_id=5',array(),'',array('tla_id', 'tla_number', 'active'));
            foreach($results as $row) {
