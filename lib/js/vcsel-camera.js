function VcselCameraAnalyzer(options) {
    ...
    this.getLotNumber = options.getLotNumber || function() { return ''; };
...
VcselCameraAnalyzer.prototype.captureSerialResult = function(resultText) {
    ...
    if (!/^[A-Z0-9]{4}$/.test(this.getLotNumber())) {
        this.statusCallback('Enter a four character lot number');
        return false;
    }
...
VcselCameraAnalyzer.prototype.saveMeasurement = function(serial, acquired) {
    ...
    var lotNumber = this.getLotNumber();
