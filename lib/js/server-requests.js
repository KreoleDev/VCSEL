    ...
    _createClass(serverRequest, [{
        ...
        value: function postToServer(postValue, subDirectory) {
            ...
            return new Promise(function (resolve, reject) {
                postValue = _this.addLoggedInUserToVcselPayload(postValue);
        ...
        key: 'addLoggedInUserToVcselPayload',
        value: function addLoggedInUserToVcselPayload(postValue) {
            if (!postValue || postValue.mode !== 'saveVcselResults') {
                return postValue;
            }
            ...
            var loggedInUserId = sessionStorage.getItem('pertechUserId') || '';
            var loggedInUsername = sessionStorage.getItem('pertechUsername') || '';
            var displayName = sessionStorage.getItem('pertechDisplayName') || '';
