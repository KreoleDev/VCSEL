    ...
    _createClass(serverRequest, [{
        ...
        value: function postToServer(postValue, subDirectory) {
            ...
            return new Promise(function (resolve, reject) {
                axios.post(_this.SERVER_URL + subDirectory, postValue, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).then(function (response) {
